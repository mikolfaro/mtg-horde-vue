...
const Template = (args, { argTypes }) => ({
  ...
  template:
    ...
    '<ListModal v-bind="$props" @close="close" @card-change="cardChange" @exile="exile" @discard="discard" @shuffleInDeck="shuffleInDeck" />' +
    '</div>',
  props: Object.keys(argTypes),
  methods: {
    close: action('close'),
    cardChange: action('cardChange'),
    exile: action('exile'),
    discard: action('discard'),
    shuffleInDeck: action('shuffleInDeck')
  }
})
...
withActions.args = {
  title: "List with some actions",
  isOpen: true,
  cards: cards,
  actions: {
    discard: "Discard",
    exile: "Exile",
    shuffleInDeck: "Shuffle in deck",
  }
}
